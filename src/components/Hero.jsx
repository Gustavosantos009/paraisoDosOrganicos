        ...
        <>
            <section  ref={innerRef} className="hero bg-[var(--bege)] h-screen gap-10 flex felex-row pt-30   justify-between">
                <div className="hero-text  text-[var(--verde_musgo)] flex flex-col h-full items-center gap-4 justify-center w-full">
                    ...
                    <Link to={`https://wa.me/5561999924626?text=${encodeURIComponent('Olá! Quero mais info sobre o produto')}`} className="bg-[var(--laranja)] w-32 h-11 text-white font-semibold rounded-lg mt-7 cursor-pointer hover:bg-[var(--laranja_escuro)] flex justify-center items-center ">comprar agora</Link>
                </div>
